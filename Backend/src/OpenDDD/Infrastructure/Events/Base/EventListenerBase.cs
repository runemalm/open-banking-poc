...
namespace OpenDDD.Infrastructure.Events.Base
{
        ...
        where TAction : class
    {
        ...
        public async Task StartAsync(CancellationToken ct)
        {
            ...
            if (_options.PersistenceProvider == "EfCore")
            {
                _logger.LogInformation("Waiting for database setup to complete before subscribing to events...");
                await _startupService.StartupCompleted;
                _logger.LogInformation("Database setup completed. Subscribing to events...");
            }
